...
import useDeviceTypeItemForm from '../hooks/DeviceTypesItemFormHook.js';
import DeviceTypesItemForm from './DeviceTypesItemForm.jsx';

const DeviceTypesForm = ({ id }) => {
  ...
  return (
    <div className="row justify-content-center">
      <Form className='col-lg-11 col-xl-10' noValidate validated={validated} onSubmit={onSubmit}>
        <div className='d-flex justify-content-center fs-2 fw-bold admin-title mt-2'>Тип устройства</div>
        <DeviceTypesItemForm item={item} handleChange={handleChange} validated={validated} />
...
export default DeviceTypesForm;