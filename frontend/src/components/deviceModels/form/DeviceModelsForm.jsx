...
import useDeviceModelsItemForm from '../hooks/DeviceModelsItemFormHook.js';
import DeviceModelsItemForm from './DeviceModelsItemForm.jsx';

const DeviceModelsForm = ({ id }) => {
  ...
  return (
    <div className="row justify-content-center">
      <Form className='col-lg-11 col-xl-10' noValidate validated={validated} onSubmit={onSubmit}>
        <div className='d-flex justify-content-center fs-2 fw-bold admin-title mt-2'>Модель устройства</div>
        <DeviceModelsItemForm
          id={id}
          item={item}
          handleChange={handleChange}
          validated={validated}
          handleManufacturerChange={handleManufacturerChange}
          handleDeviceTypeChange={handleTypeChange}
          handleStructureElementsChange={handleStructureElementsChange}
          initialManufacturer={initialManufacturer}
          initialDeviceType={initialDeviceType}
          initialStructureElements={initialStructureElements}
        />
...
export default DeviceModelsForm;