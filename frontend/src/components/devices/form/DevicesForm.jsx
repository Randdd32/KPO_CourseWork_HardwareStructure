...
import useDeviceItemForm from '../hooks/DevicesItemFormHook.js';
import DevicesItemForm from './DevicesItemForm.jsx';
  ...
  return (
    <div className="row justify-content-center">
      <Form className='col-lg-11 col-xl-10' noValidate validated={validated} onSubmit={onSubmit}>
        <div className='d-flex justify-content-center fs-2 fw-bold admin-title mt-2'>Устройство</div>
        <DevicesItemForm
          id={id}
          item={item}
