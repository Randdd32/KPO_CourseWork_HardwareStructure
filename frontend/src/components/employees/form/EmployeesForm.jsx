...
import useEmployeeItemForm from '../hooks/EmployeesItemFormHook.js';
import EmployeeItemForm from './EmployeesItemForm.jsx';
  ...
  return (
    <div className="row justify-content-center">
      <Form className="col-lg-11 col-xl-10" noValidate validated={validated} onSubmit={onSubmit}>
        <div className="d-flex justify-content-center fs-2 fw-bold admin-title mt-2">Сотрудник</div>
        <EmployeeItemForm
          id={id}
          item={item}
