...
import useBuildingsItemForm from '../hooks/BuildingsItemFormHook';
import BuildingsItemForm from './BuildingsItemForm.jsx';

const BuildingsForm = ({ id }) => {
  ...
  return (
    <div className="row justify-content-center">
      <Form className='col-lg-11 col-xl-10' noValidate validated={validated} onSubmit={onSubmit}>
        <div className='d-flex justify-content-center fs-2 fw-bold admin-title mt-2'>Здание</div>
        <BuildingsItemForm item={item} handleChange={handleChange} validated={validated} />
